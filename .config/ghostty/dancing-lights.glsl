...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec3 blendedColor = mix(terminalColor.rgb, vec3(cloudIntensity1*clouds(uv))*lightColor1 + lighIntensity1*lightColor1 + vec3(cloudIntensity2*clouds(uv))*lightColor2 + lighIntensity2*lightColor2 + vec3(cloudIntensity3*clouds(uv))*lightColor3 + lighIntensity3*lightColor3, mask);
